...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/powerhint/vendor/powerhint.json:$(TARGET_COPY_OUT_VENDOR)/etc/powerhint.json \
    $(LOCAL_PATH)/configs/powerhint/vendor/powerhint.json:$(TARGET_COPY_OUT_VENDOR)/etc/powerhint-boost.json \
